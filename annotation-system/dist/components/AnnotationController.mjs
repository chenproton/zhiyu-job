...
export function AnnotationController({ mode, setMode, user, setUser, annotationCount, zIndex = 500, theme, }) {
    ...
    return (_jsxs("div", { className: `fixed bg-white rounded-xl shadow-lg border border-gray-200 p-3 select-none transition-shadow ${isDragging ? 'shadow-2xl cursor-grabbing' : 'cursor-grab'}`, style: {
            ...
            color: theme?.panelText ?? '#374151',
        }, onMouseDown: handleMouseDown, children: [_jsxs("div", { className: "flex items-center gap-2 mb-3", children: [_jsx(GripVertical, { className: "w-4 h-4 text-muted-foreground" }), _jsx("div", { className: "w-3 h-3 rounded-full", style: {
                            backgroundColor: mode === 'off' ? '#9ca3af' : mode === 'view' ? secondaryColor : primaryColor,
                        } }), _jsx("span", { className: "text-sm font-medium", children: "\u9875\u9762\u6807\u6CE8" }), annotationCount > 0 && (_jsx("span", { className: "text-xs bg-secondary text-secondary-foreground px-2 py-0.5 rounded-full", children: annotationCount }))] }), _jsx("div", { className: "flex gap-1 mb-3", children: modes.map((m) => {
                ...
                }) }), _jsxs("div", { className: "flex items-center justify-between text-xs", children: [_jsxs("div", { className: "flex items-center gap-1 text-muted-foreground", children: [_jsx(Settings, { className: "w-3 h-3" }), _jsx("span", { children: "\u7528\u6237:" })] }), editingUser ? (_jsxs("div", { className: "flex gap-1", children: [_jsx("input", { type: "text", value: tempUser, onChange: (e) => setTempUser(e.target.value), className: "text-xs px-2 py-0.5 border border-input rounded focus:outline-none focus:ring-1 focus:ring-ring w-16", onKeyDown: (e) => e.key === 'Enter' && handleUserSave(), onClick: (e) => e.stopPropagation() }), _jsx("button", { onClick: (e) => {
                                    e.stopPropagation();
                                    handleUserSave();
                                }, className: "text-xs px-2 py-0.5 bg-primary text-primary-foreground rounded hover:bg-primary/90", children: "\u786E\u5B9A" })] })) : (_jsx("button", { onClick: (e) => {
                            e.stopPropagation();
                            setEditingUser(true);
                        }, className: "text-xs text-primary hover:text-primary/80 font-medium", children: user }))] }), _jsxs("div", { className: "text-xs text-muted-foreground mt-2 pt-2 border-t border-border/50", children: [mode === 'edit' && _jsx("p", { children: "\u70B9\u51FB\u9875\u9762\u4EFB\u610F\u4F4D\u7F6E\u521B\u5EFA\u6807\u6CE8" }), mode === 'view' && _jsx("p", { children: "\u70B9\u51FB\u6807\u6CE8\u70B9\u67E5\u770B\u8BE6\u60C5\u4E0E\u8BC4\u8BBA" }), mode === 'off' && _jsx("p", { children: "\u6807\u6CE8\u5DF2\u9690\u85CF" })] })] }));
}
