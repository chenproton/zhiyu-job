...
export const mockPositionCareerPathGeneration = (positionName?: string): AiCareerPath => {
  return {
    horizontal: ["技术专家", "产品经理", "项目经理", "技术顾问", "解决方案架构师"],
    vertical: ["初级工程师", "中级工程师", "高级工程师", "技术主管", "架构师", "技术总监"],
  }
}
...
const WMS_PRODUCT_MANAGER: AiPositionPreview = {
  ...
  careerPath: {
    horizontal: ["供应链产品经理", "OMS 产品经理", "TMS 产品经理", "ERP 产品经理", "SaaS 产品专家"],
    vertical: ["产品专员", "产品经理", "高级产品经理", "产品负责人", "产品总监", "VP 产品"]
  },
