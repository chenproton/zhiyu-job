...
export default function PositionsPage() {
  ...
  const handleCloseGeneratedDialog = () => {
    ...
    router.replace('/ai-assisted/positions')
  }
  ...
  const handleCreate = () => {
    ...
    router.push(`/ai-assisted/positions/${newPosition.id}/edit`)
  }
      ...
      <Card className="border-slate-200 shadow-sm">
        <CardContent className="p-4">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div>
              <h1 className="text-xl font-semibold text-slate-900">岗位资源管理(AI辅助)</h1>
              <p className="text-xs text-slate-500 mt-0.5">
                维护岗位信息、能力模型等岗位资源管理功能 — AI 辅助模式
              </p>
            </div>
        ...
        {filteredPositions.length > 0 && viewMode !== "group" && (
          <CardContent className="pt-0">
            <PositionList
              ...
              basePath="/ai-assisted/positions"
            />
          </CardContent>
        )}
      </Card>
