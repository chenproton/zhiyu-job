...
import { Building2, Phone, Mail, MapPin, User, ImageIcon, FileText } from 'lucide-react'
      ...
      <div className="mx-auto max-w-7xl space-y-4">
        ...
        <Card className="border border-slate-200 shadow-sm">
          ...
          <CardContent className="space-y-6">
            <div>
              <h3 className="mb-2 text-sm font-medium text-slate-900">企业简介</h3>
              <p className="text-sm leading-relaxed text-slate-600">{data.intro}</p>
            </div>

            <div className="border-t border-slate-100 pt-5">
              <h3 className="mb-4 text-sm font-medium text-slate-900">其他信息</h3>
              <div className="grid grid-cols-1 gap-y-5 gap-x-8 sm:grid-cols-2 lg:grid-cols-3">
                <div>
                  ...
                  <div className="mt-1 text-sm font-medium text-slate-900">{data.type}</div>
                </div>
                <div>
                  <div className="text-xs text-slate-400">统一社会信用代码</div>
                  <div className="mt-1 text-sm font-medium text-slate-900">{data.creditCode}</div>
                </div>
                <div>
                  <div className="text-xs text-slate-400">成立年份</div>
                  <div className="mt-1 text-sm font-medium text-slate-900">{data.foundedYear}</div>
                </div>
                <div>
                  <div className="text-xs text-slate-400">员工规模</div>
                  <div className="mt-1 text-sm font-medium text-slate-900">{data.staffSize}</div>
                </div>
                <div>
                  <div className="text-xs text-slate-400">创建时间</div>
                  <div className="mt-1 text-sm font-medium text-slate-900">{data.createdAt}</div>
                </div>
                <div>
                  <div className="text-xs text-slate-400">更新时间</div>
                  <div className="mt-1 text-sm font-medium text-slate-900">{data.updatedAt}</div>
                </div>
                <div>
                  <div className="text-xs text-slate-400">关联二级学院</div>
                  <div className="mt-1 text-sm font-medium text-slate-900">{data.college}</div>
                </div>
              </div>
            </div>
          </CardContent>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm font-medium text-slate-900">{data.contact.name}</div>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm font-medium text-slate-900">{data.contact.phone}</div>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm font-medium text-slate-900">{data.contact.email}</div>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm font-medium text-slate-900">{data.contact.address}</div>
                </div>
              </div>
            </CardContent>
          </Card>
